...
Current scope is limited to advice-only for the first 50 turns of a game. See [`CLAUDE.md`](CLAUDE.md) for full architecture, constraints, and design decisions, and [`REFERENCES.md`](REFERENCES.md) for API docs and prior art.
